...
lib.ssMetadata = [
		{name:"300x250_AdWords_MREC_v2_atlas_P_", frames: [[0,0,341,487],[343,0,135,156]]}
];
...
(lib._4pc1 = function() {
	this.spriteSheet = ss["300x250_AdWords_MREC_v2_atlas_P_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._300x250_AdWords_MREC_v2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/300x250_AdWords_MREC_v2_atlas_P_.png", id:"300x250_AdWords_MREC_v2_atlas_P_"}
	],
	preloads: []
};
