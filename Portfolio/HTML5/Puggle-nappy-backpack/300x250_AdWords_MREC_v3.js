...
lib.ssMetadata = [
		{name:"300x250_AdWords_MREC_v3_atlas_P_", frames: [[0,0,341,487],[343,0,135,156]]}
];
...
(lib._4pc1 = function() {
	this.spriteSheet = ss["300x250_AdWords_MREC_v3_atlas_P_"];
	this.gotoAndStop(0);
...
(lib.txt23 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("AAGAZIgGghIgFAhIgUAAIgHgwIANAAIAFAkIAIgkIANAAIAIAkIAEgkIAOAAIgJAwg");
	this.shape.setTransform(250.5,122.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgCAZQgLAAgEgEQgEgFAAgLIAAgJQAAgMAEgDQAEgFALAAIAFAAQAKAAAFAFQAEADAAAMIAAAJQAAALgEAFQgFAEgKAAgAgGgLQgBACgBAGIAAAHQABAHABABQABABAFABIABAAQAEgBACgBQABgBABgHIAAgHQgBgGgBgCQgCgCgEABIgBAAQgEgBgCACg");
	this.shape_1.setTransform(244.4,122.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAEAZIgOgkIAAAkIgNAAIAAgwIAUAAIAOAjIAAgjIANAAIAAAwg");
	this.shape_2.setTransform(239,122.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgSAZIAAgwIAkAAIAAALIgXAAIAAAIIAWAAIAAAJIgWAAIAAAJIAYAAIAAALg");
	this.shape_3.setTransform(231.5,122.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgRAZIAAgwIAOAAIAAAkIAVAAIAAAMg");
	this.shape_4.setTransform(227.3,122.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgTAZIAAgwIAWAAQAJAAAEACQADADAAAGIAAADQAAAEgCADQgCACgEAAQAEAAADADQACACAAAEIAAADQAAAHgEADQgDADgKAAgAgGAOIAJAAIADgBIABgDIAAgCIgBgDIgDAAIgJAAgAgGgEIAIAAIADgBQAAAAABAAQAAgBAAAAQAAAAAAgBQAAAAAAgBIAAgCIgBgCIgDAAIgIAAg");
	this.shape_5.setTransform(222.6,122.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAKAZIgCgJIgPAAIgCAJIgOAAIAOgwIATAAIAOAwgAgFAGIAKAAIgEgTIgBAAg");
	this.shape_6.setTransform(217.6,122.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgRAZIAAgwIAOAAIAAAkIAVAAIAAAMg");
	this.shape_7.setTransform(213.2,122.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgFAZIAAgwIALAAIAAAwg");
	this.shape_8.setTransform(209.7,122.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAKAZIgCgJIgPAAIgCAJIgOAAIAOgwIATAAIAOAwgAgFAGIAKAAIgEgTIgBAAg");
	this.shape_9.setTransform(206,122.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgJAZIgNgwIANAAIAJAlIAKglIAOAAIgPAwg");
	this.shape_10.setTransform(201,122.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AAKAZIgCgJIgPAAIgCAJIgOAAIAOgwIATAAIAOAwgAgFAGIAKAAIgEgTIgBAAg");
	this.shape_11.setTransform(196,122.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAFAZIgMgUIgBAAIAAAUIgNAAIAAgwIANAAIAAASIABAAIALgSIAQAAIgQAXIASAZg");
	this.shape_12.setTransform(188.8,122.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgBAZQgKAAgEgEQgEgFgBgLIAAgJQABgMAEgDQAEgFAKAAIADAAQAKAAAFAEQADAEAAAJIAAACIgMAAIAAgCQgBgDgCgBIgEgBQgEgBgCACQgBACAAAGIAAAHQAAAHABABQACABAEABQAEgBABgBQACgCAAgEIAAAAIAMAAIAAABQAAAJgDAFQgFAEgJAAg");
	this.shape_13.setTransform(183.8,122.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AAKAZIgDgJIgOAAIgCAJIgOAAIAOgwIATAAIAOAwgAgEAGIAKAAIgGgTIAAAAg");
	this.shape_14.setTransform(178.9,122.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("A
2);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FFFFFF").s().p("AgVAZIAAgwIAYAAQAKgBAFAFQAEAEAAALIAAAJQAAALgEAEQgFAEgKABgAgIAOIAJAAQAFgBABgBQACgBAAgHIAAgHQAAgGgCgCQgBgCgFABIgJAAg");
	this.shape_32.setTransform(85.2,122.2);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFFFFF").s().p("AAKAZIgDgJIgOAAIgCAJIgOAAIAOgwIATAAIAOAwgAgEAGIAKAAIgGgTIAAAAg");
	this.shape_33.setTransform(79.9,122.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.txt23, new cjs.Rectangle(76.3,117,179,10.5), null);
...
(lib.btn = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AARBHIgRhfIgSBfIg2AAIgViNIAlAAIAOBsIAWhsIAqAAIATBsIAQhsIAmAAIgYCNg");
	this.shape.setTransform(117.8,18.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgJBIQgdAAgMgMQgNgNAAggIAAgdQAAggANgNQAMgMAdAAIASAAQAeAAAMAMQANANAAAgIAAAdQAAAggNANQgMAMgeAAgAgUghQgEAEAAASIAAAXQAAASAEAFQAEAEANAAIAHAAQAMAAAFgFQADgEAAgSIAAgXQAAgSgDgEQgFgFgMAAIgHAAQgNAAgEAFg");
	this.shape_1.setTransform(100.4,18.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAMBHIgrhpIAABpIgkAAIAAiNIA4AAIArBoIAAhoIAkAAIAACNg");
	this.shape_2.setTransform(84.8,18.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("Ag6BHIAAiNIBBAAQAcAAAMALQAMALAAAZIAAAKQAAAYgMALQgMALgcAAIgbAAIAAAmgAgUABIAZAAQAJAAADgCQADgDAAgKIAAgIQAAgJgDgDQgEgEgKAAIgXAAg");
	this.shape_3.setTransform(63.1,18.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgIBIQgfAAgLgMQgMgNAAggIAAgdQAAggAMgNQALgMAfAAIARAAQAeAAAMAMQAMANABAgIAAAdQgBAggMANQgMAMgeAAgAgUghQgEAEAAASIAAAXQAAASAEAFQAEAEANAAIAGAAQAOAAADgFQAEgEAAgSIAAgXQAAgSgEgEQgDgFgOAAIgGAAQgNAAgEAFg");
	this.shape_4.setTransform(48.4,18.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAYBHIAAg4IgvAAIAAA4IgmAAIAAiNIAmAAIAAA1IAvAAIAAg1IAmAAIAACNg");
	this.shape_5.setTransform(33.3,18.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(18.8,18.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#FFFFFF").ss(1,1,1).p("AouifIRdAAQAyAAAAAyIAADbQAAAygyAAIxdAAQgyAAAAgyIAAjbQAAgyAyAAg");
	this.shape_7.setTransform(70,18.4,1.15,1.15);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#79AFFF").s().p("AouCgQgyAAAAgyIAAjbQAAgyAyAAIRdAAQAyAAAAAyIAADbQAAAygyAAg");
	this.shape_8.setTransform(70,18.4,1.15,1.15);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.btn, new cjs.Rectangle(-1,-1,142,38.8), null);
...
// stage content:
(lib._300x250_AdWords_MREC_v3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(889).call(this.frame_889).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(23).to({_off:false},0).to({y:223,alpha:1},10).wait(89).to({y:318},6,cjs.Ease.get(1)).to({_off:true},1).wait(6).to({_off:false,regY:30.9,scaleX:0.57,scaleY:0.57,x:45.6,y:292.1},0).to({y:232.1},6,cjs.Ease.get(1)).wait(213).to({y:292.1},6,cjs.Ease.get(-1)).to({_off:true},1).wait(23).to({_off:false,regY:31,scaleX:1,scaleY:1,x:79,y:248,alpha:0},0).to({y:223,alpha:1},10).wait(89).to({y:318},6,cjs.Ease.get(1)).to({_off:true},1).wait(6).to({_off:false,regY:30.9,scaleX:0.57,scaleY:0.57,x:45.6,y:292.1},0).to({y:232.1},6,cjs.Ease.get(1)).wait(213).to({y:292.1},6,cjs.Ease.get(-1)).to({_off:true},1).wait(23).to({_off:false,regY:31,scaleX:1,scaleY:1,x:79,y:248,alpha:0},0).to({y:223,alpha:1},10).wait(79).to({y:318},6,cjs.Ease.get(1)).to({_off:true},1).wait(6).to({_off:false,regY:30.9,scaleX:0.57,scaleY:0.57,x:45.6,y:292.1},0).to({y:232.1},6,cjs.Ease.get(1)).wait(44));

	// ABOUT
	this.instance_1 = new lib.btn();
	this.instance_1.parent = this;
	this.instance_1.setTransform(176.4,270.6,1,1,0,0,0,70,18.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(259).to({_off:false},0).to({y:217.8},9,cjs.Ease.get(0.98)).wait(79).to({y:268.2},7,cjs.Ease.get(-1)).to({_off:true},1).wait(265).to({_off:false,y:270.6},0).to({y:217.8},9,cjs.Ease.get(0.98)).wait(79).to({y:268.2},7,cjs.Ease.get(-1)).to({_off:true},1).wait(165).to({_off:false,y:270.6},0).to({scaleX:0.87,scaleY:0.87,x:178.4,y:223.4},7,cjs.Ease.get(1)).wait(9));

	// Pc-1-1.png
	this.instance_2 = new lib.txt23();
	this.instance_2.parent = this;
	this.instance_2.setTransform(43.2,156.9,1,1,0,0,0,62.1,43.6);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(141).to({_off:false},0).to({x:73.2,alpha:1},10,cjs.Ease.get(1)).wait(93).to({y:170.9,alpha:0},9,cjs.Ease.get(-1)).to({_off:true},1).wait(248).to({_off:false,x:43.2,y:156.9},0).to({x:73.2,alpha:1},10,cjs.Ease.get(1)).wait(93).to({y:170.9,alpha:0},9,cjs.Ease.get(-1)).to({_off:true},1).wait(231).to({_off:false,x:43.2,y:156.9},0).to({x:73.2,alpha:1},7,cjs.Ease.get(1)).wait(28).to({x:74,y:117.7},7,cjs.Ease.get(1)).wait(9));

	// ABOUT
	this.instance_3 = new lib.t24();
	this.instance_3.parent = this;
	this.instance_3.setTransform(19.6,101.9,1,1,0,0,0,48.6,20.4);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({x:49.6,alpha:1},10,cjs.Ease.get(1)).wait(105).to({y:115.9,alpha:0},9,cjs.Ease.get(-1)).to({_off:true},1).wait(236).to({_off:false,x:19.6,y:101.9},0).to({x:49.6,alpha:1},10,cjs.Ease.get(1)).wait(105).to({y:115.9,alpha:0},9,cjs.Ease.get(-1)).to({_off:true},1).wait(219).to({_off:false,x:19.6,y:101.9},0).to({x:49.6,alpha:1},6,cjs.Ease.get(1)).wait(32).to({y:99.9,alpha:0},6,cjs.Ease.get(-1)).to({_off:true},1).wait(12));

	// Pc-1-2.png
	this.instance_4 = new lib.girlfront2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(384,137.5,1,1,0,0,0,72,112.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:219,y:136.5},10,cjs.Ease.get(1)).wait(104).to({x:379},8).to({_off:true},1).wait(238).to({_off:false,x:384,y:137.5},0).to({x:219,y:136.5},10,cjs.Ease.get(1)).wait(104).to({x:379},8).to({_off:true},1).wait(238).to({_off:false,x:384,y:137.5},0).to({x:219,y:136.5},10,cjs.Ease.get(1)).wait(94).to({x:379},8).to({_off:true},1).wait(62));

	// FREAKING OUT
	this.instance_5 = new lib.txt1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(229.2,46.9,1,1,0,0,0,80.1,43.6);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:91.2,alpha:1},10,cjs.Ease.get(1)).wait(100).to({x:71.2,alpha:0},8).to({_off:true},1).wait(242).to({_off:false,x:229.2},0).to({x:91.2,alpha:1},10,cjs.Ease.get(1)).wait(100).to({x:71.2,alpha:0},8).to({_off:true},1).wait(242).to({_off:false,x:229.2},0).to({x:91.2,alpha:1},10,cjs.Ease.get(1)).wait(90).to({x:71.2,alpha:0},8).to({_off:true},1).wait(66));

	// Слой 5
	this.instance_6 = new lib.txt2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(43.2,156.9,1,1,0,0,0,62.1,43.6);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({_off:false},0).to({x:73.2,alpha:1},10,cjs.Ease.get(1)).wait(98).to({x:53.2,alpha:0},8).to({_off:true},1).wait(244).to({_off:false,x:43.2},0).to({x:73.2,alpha:1},10,cjs.Ease.get(1)).wait(98).to({x:53.2,alpha:0},8).to({_off:true},1).wait(244).to({_off:false,x:43.2},0).to({x:73.2,alpha:1},10,cjs.Ease.get(1)).wait(88).to({x:53.2,alpha:0},8).to({_off:true},1).wait(62));

	// ABOUT
	this.instance_7 = new lib.about();
	this.instance_7.parent = this;
	this.instance_7.setTransform(19.6,101.9,1,1,0,0,0,48.6,20.4);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(12).to({_off:false},0).to({x:49.6,alpha:1},10,cjs.Ease.get(1)).wait(98).to({x:29.6,alpha:0},9).to({_off:true},1).wait(243).to({_off:false,x:19.6},0).to({x:49.6,alpha:1},10,cjs.Ease.get(1)).wait(98).to({x:29.6,alpha:0},9).to({_off:true},1).wait(243).to({_off:false,x:19.6},0).to({x:49.6,alpha:1},10,cjs.Ease.get(1)).wait(88).to({x:29.6,alpha:0},9).to({_off:true},1).wait(55));

	// Слой 2
	this.instance_8 = new lib.pc2_1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(150,92,0.5,0.5,0,0,0,300,184);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(125).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(0.98)).wait(223).to({alpha:0},6,cjs.Ease.get(-1)).to({_off:true},1).wait(125).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(0.98)).wait(223).to({alpha:0},6,cjs.Ease.get(-1)).to({_off:true},1).wait(115).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(0.98)).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape}]},125).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},223).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},125).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},223).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},115).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).wait(54));
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(125).to({_off:true},1).wait(234).to({_off:false},0).wait(126).to({_off:true},1).wait(234).to({_off:false},0).wait(116).to({_off:true},1).wait(59));
	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(131).to({_off:false},0).wait(223).to({_off:true},1).wait(137).to({_off:false},0).wait(223).to({_off:true},1).wait(127).to({_off:false},0).wait(54));

	// Слой 6
	this.instance_9 = new lib.plate();
	this.instance_9.parent = this;
	this.instance_9.setTransform(150,274,1,1,0,0,0,150,23.6);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(19).to({_off:false},0).to({y:229},10,cjs.Ease.get(1)).wait(96).to({y:337},7).to({_off:true},1).wait(247).to({_off:false,y:274},0).to({y:229},10,cjs.Ease.get(1)).wait(96).to({y:337},7).to({_off:true},1).wait(247).to({_off:false,y:274},0).to({y:229},10,cjs.Ease.get(1)).wait(86).to({y:337},7).to({_off:true},1).wait(52));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12}]}).to({state:[{t:this.shape_12}]},125).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_12}]},229).to({state:[{t:this.shape_12}]},125).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_12}]},229).to({state:[{t:this.shape_12}]},115).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).wait(53));
	this.timeline.addTween(cjs.Tween.get(this.shape_12).wait(125).to({_off:true},1).wait(235).to({_off:false},0).wait(125).to({_off:true},1).wait(235).to({_off:false},0).wait(115).to({_off:true},1).wait(59));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/300x250_AdWords_MREC_v3_atlas_P_.png", id:"300x250_AdWords_MREC_v3_atlas_P_"}
	],
	preloads: []
};
