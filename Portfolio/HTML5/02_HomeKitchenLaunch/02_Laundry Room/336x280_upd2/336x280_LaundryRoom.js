...
lib.ssMetadata = [
		{name:"336x280_LaundryRoom_atlas_P_", frames: [[0,0,98,28]]},
		{name:"336x280_LaundryRoom_atlas_NP_", frames: [[456,0,454,280],[676,282,336,280],[338,282,336,280],[0,282,336,280],[0,0,454,280]]}
];
...
(lib.NewAgelogo = function() {
	this.initialize(ss["336x280_LaundryRoom_atlas_P_"]);
	this.gotoAndStop(0);
...
(lib.screen11 = function() {
	this.initialize(ss["336x280_LaundryRoom_atlas_NP_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.t31 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#000000").s().p("AgnA5IAAhxIBQAAIAAAVIg5AAIAAAYIA3AAIAAAVIg3AAIAAAaIA5AAIAAAVg");
	this.shape.setTransform(216.5,85.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AASA5IgVgoIgSAAIAAAoIgYAAIAAhxIA0AAQAMAAAJAFQAIAEAFAJQAFAIAAALQAAAKgEAHQgEAGgFAEQgGAEgGACIAZArgAgVgEIAZAAQAHAAAFgEQAFgEAAgIQAAgHgFgEQgFgEgHAAIgZAAg");
	this.shape_1.setTransform(206.025,85.725);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AAgA5IgIgTIgwAAIgHATIgbAAIAshxIAdAAIAsBxgAASAQIgSgwIgRAwIAjAAg");
	this.shape_2.setTransform(194.375,85.725);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AAUA5IgUhNIgTBNIgaAAIghhxIAcAAIAUBRIAWhRIASAAIAVBRIAUhRIAcAAIghBxg");
	this.shape_3.setTransform(180.625,85.725);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("Ag0A5IAAhxIAtAAQARAAANAHQAOAHAIANQAHANABAQQgBARgHANQgIANgNAHQgOAHgRAAgAgcAkIAVAAQAKAAAJgFQAHgFAEgIQAFgIAAgKQAAgJgEgIQgEgIgIgFQgIgFgLAAIgVAAg");
	this.shape_4.setTransform(166.85,85.725);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AASA5IgVgoIgSAAIAAAoIgYAAIAAhxIA0AAQAMAAAJAFQAIAEAFAJQAFAIAAALQAAAKgEAHQgEAGgFAEQgGAEgGACIAZArgAgVgEIAZAAQAHAAAFgEQAFgEAAgIQAAgHgFgEQgFgEgHAAIgZAAg");
	this.shape_5.setTransform(155.125,85.725);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AAgA5IgIgTIgwAAIgHATIgbAAIAshxIAdAAIAsBxgAASAQIgSgwIgRAwIAjAAg");
	this.shape_6.setTransform(143.475,85.725);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AAbA5IAAgwIg1AAIAAAwIgZAAIAAhxIAZAAIAAAtIA1AAIAAgtIAZAAIAABxg");
	this.shape_7.setTransform(131.35,85.725);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("");
	this.shape_8.setTransform(115.175,85.75);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("");
	this.shape_9.setTransform(99.875,85.75);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AgoA5IAAhxIBQAAIAAAVIg3AAIAAAYIA2AAIAAAVIg2AAIAAAaIA3AAIAAAVg");
	this.shape_10.setTransform(90,85.725);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AgLA5IAAhxIAXAAIAABxg");
	this.shape_11.setTransform(82.4,85.725);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AASA5IgVgoIgSAAIAAAoIgYAAIAAhxIA0AAQAMAAAJAFQAIAEAFAJQAFAIAAALQAAAKgEAHQgEAGgFAEQgGAEgGACIAZArgAgVgEIAZAAQAHAAAFgEQAFgEAAgIQAAgHgFgEQgFgEgHAAIgZAAg");
	this.shape_12.setTransform(74.775,85.725);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AgeA0QgNgIgIgNQgIgOAAgRQAAgQAIgOQAIgNANgHQAOgIAQAAQARAAAOAIQANAHAIANQAIAOAAAQQAAARgIAOQgIANgNAIQgOAHgRAAQgQAAgOgHgAgRggQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAHAFAKAAQALAAAHgFQAIgFAEgJQAFgIAAgLQAAgKgFgIQgEgJgIgFQgHgEgLAAQgKAAgHAEg");
	this.shape_13.setTransform(62.425,85.725);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("");
	this.shape_14.setTransform(50.625,85.75);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("");
	this.shape_15.setTransform(40.325,85.75);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AgoA5IAAhxIBQAAIAAAVIg4AAIAAAYIA3AAIAAAVIg3AAIAAAaIA4AAIAAAVg");
	this.shape_16.setTransform(30.45,85.725);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgXA0QgOgIgIgNQgIgNAAgSQAAgRAIgNQAIgNAOgIQANgHARAAQAMAAAJAEQAKAEAGAGQAGAHAEAHIgVAKQgDgHgHgFQgHgEgJAAQgKAAgIAEQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAIAFAKAAQAJgBAHgEQAHgFADgHIAVAKQgEAHgGAHQgGAGgKAEQgJAEgMAAQgRAAgNgHg");
	this.shape_17.setTransform(19.475,85.725);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AgXA0QgOgIgIgNQgIgNAAgSQAAgRAIgNQAIgNAOgIQANgHARAAQAMAAAJAEQAKAEAGAGQAGAHAEAHIgVAKQgDgHgHgFQgHgEgJAAQgKAAgIAEQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAIAFAKAAQAJgBAHgEQAHgFADgHIAVAKQgEAHgGAHQgGAGgKAEQgJAEgMAAQgRAAgNgHg");
	this.shape_18.setTransform(7.675,85.725);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("AAgA5IgIgTIgwAAIgHATIgbAAIAshxIAdAAIAsBxgAASAQIgSgwIgRAwIAjAAg");
	this.shape_19.setTransform(-4.225,85.725);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#000000").s().p("AgLA5IAAhcIgiAAIAAgVIBaAAIAAAVIggAAIAABcg");
	this.shape_20.setTransform(191.95,67.025);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#000000").s().p("AgnA5IAAhxIBPAAIAAAVIg3AAIAAAYIA2AAIAAAVIg2AAIAAAaIA3AAIAAAVg");
	this.shape_21.setTransform(181.35,67.025);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("AAcA5Ig2hJIAABJIgYAAIAAhxIAZAAIA0BHIAAhHIAYAAIAABxg");
	this.shape_22.setTransform(169.075,67.025);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#000000").s().p("AgLA5IAAhxIAXAAIAABxg");
	this.shape_23.setTransform(159.65,67.025);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#000000").s().p("AgvA5IAAhxIA7AAQALAAAIAEQAHAEAEAHQADAGAAAIQAAAHgCAGQgDAFgFAEQgEADgFABQAGABAFADQAFAEADAGQACAGABAHQAAAJgEAHQgEAHgHAEQgIAEgLAAgAgXAkIAfAAQAHAAAEgEQAEgDAAgGQAAgGgEgEQgEgDgHAAIgfAAgAgXgLIAeAAQAGAAAEgDQADgDAAgGQAAgFgDgDQgEgEgGAAIgeAAg");
	this.shape_24.setTransform(151.075,67.025);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#000000").s().p("AAgA5IgIgTIgwAAIgHATIgbAAIAshxIAdAAIAsBxgAASAQIgSgwIgRAwIAjAAg");
	this.shape_25.setTransform(138.475,67.025);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#000000").s().p("AgXA0QgOgIgIgNQgIgNAAgSQAAgRAIgNQAIgNAOgIQANgHARAAQAMAAAJAEQAKAEAGAGQAGAHAEAHIgVAKQgDgHgHgFQgHgEgJAAQgKAAgIAEQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAIAFAKAAQAJgBAHgEQAHgFADgHIAVAKQgEAHgGAHQgGAGgKAEQgJAEgMAAQgRAAgNgHg");
	this.shape_26.setTransform(126.075,67.025);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#000000").s().p("AAbA5IAAgwIg2AAIAAAwIgXAAIAAhxIAXAAIAAAtIA2AAIAAgtIAYAAIAABxg");
	this.shape_27.setTransform(107.8,67.025);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#000000").s().p("AgLA5IAAhcIghAAIAAgVIBZAAIAAAVIghAAIAABcg");
	this.shape_28.setTransform(95.8,67.025);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#000000").s().p("AgLA5IAAhxIAXAAIAABxg");
	this.shape_29.setTransform(87.65,67.025);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#000000").s().p("AAUA5IgUhNIgTBNIgaAAIghhxIAcAAIAUBRIAWhRIASAAIAVBRIAUhRIAcAAIghBxg");
	this.shape_30.setTransform(76.625,67.025);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#000000").s().p("AATA5IgiguIgJALIAAAjIgYAAIAAhxIAYAAIAAAzIAogzIAeAAIgtA1IAwA8g");
	this.shape_31.setTransform(57.9,67.025);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#000000").s().p("AgeA0QgNgIgIgNQgIgOAAgRQAAgQAIgOQAIgNANgHQAOgIAQAAQARAAAOAIQANAHAIANQAIAOAAAQQAAARgIAOQgIANgNAIQgOAHgRAAQgQAAgOgHgAgRggQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAHAFAKAAQALAAAHgFQAIgFAEgJQAFgIAAgLQAAgKgFgIQgEgJgIgFQgHgEgLAAQgKAAgHAEg");
	this.shape_32.setTransform(44.475,67.025);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#000000").s().p("AgeA0QgNgIgIgNQgIgOAAgRQAAgQAIgOQAIgNANgHQAOgIAQAAQARAAAOAIQANAHAIANQAIAOAAAQQAAARgIAOQgIANgNAIQgOAHgRAAQgQAAgOgHgAgRggQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAHAFAKAAQALAAAHgFQAIgFAEgJQAFgIAAgLQAAgKgFgIQgEgJgIgFQgHgEgLAAQgKAAgHAEg");
	this.shape_33.setTransform(30.575,67.025);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#000000").s().p("AgjA5IAAhxIAYAAIAABcIAvAAIAAAVg");
	this.shape_34.setTransform(19.025,67.025);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#000000").s().p("AAmA5IAAhRIghBRIgJAAIghhRIAABRIgYAAIAAhxIAiAAIAbBGIAchGIAiAAIAABxg");
	this.shape_35.setTransform(166.6,48.275);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#000000").s().p("AgeA0QgNgIgIgNQgIgOAAgRQAAgQAIgOQAIgNANgHQAOgIAQAAQARAAAOAIQANAHAIANQAIAOAAAQQAAARgIAOQgIANgNAIQgOAHgRAAQgQAAgOgHgAgRggQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAHAFAKAAQALAAAHgFQAIgFAEgJQAFgIAAgLQAAgKgFgIQgEgJgIgFQgHgEgLAAQgKAAgHAEg");
	this.shape_36.setTransform(152.675,48.275);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#000000").s().p("AgeA0QgNgIgIgNQgIgOAAgRQAAgQAIgOQAIgNANgHQAOgIAQAAQARAAAOAIQANAHAIANQAIAOAAAQQAAARgIAOQgIANgNAIQgOAHgRAAQgQAAgOgHgAgRggQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAHAFAKAAQALAAAHgFQAIgFAEgJQAFgIAAgLQAAgKgFgIQgEgJgIgFQgHgEgLAAQgKAAgHAEg");
	this.shape_37.setTransform(139.525,48.275);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#000000").s().p("AASA5IgVgoIgSAAIAAAoIgYAAIAAhxIA0AAQAMAAAJAFQAIAEAFAJQAFAIAAALQAAAKgEAHQgEAGgFAEQgGAEgGACIAZArgAgVgEIAZAAQAHAAAFgEQAFgEAAgIQAAgHgFgEQgFgEgHAAIgZAAg");
	this.shape_38.setTransform(127.675,48.275);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#000000").s().p("AgLA5IAAgvIgshCIAbAAIAcAuIAcguIAcAAIgsBCIAAAvg");
	this.shape_39.setTransform(111.95,48.275);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#000000").s().p("AASA5IgVgoIgSAAIAAAoIgYAAIAAhxIA0AAQAMAAAJAFQAIAEAFAJQAFAIAAALQAAAKgEAHQgEAGgFAEQgGAEgGACIAZArgAgVgEIAZAAQAHAAAFgEQAFgEAAgIQAAgHgFgEQgFgEgHAAIgZAAg");
	this.shape_40.setTransform(101.125,48.275);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#000000").s().p("Ag0A5IAAhxIAtAAQARAAAOAHQAOAHAHANQAHANABAQQgBARgHANQgHANgOAHQgOAHgRAAgAgcAkIAVAAQAKAAAIgFQAIgFAFgIQAEgIAAgKQAAgJgEgIQgEgIgIgFQgIgFgLAAIgVAAg");
	this.shape_41.setTransform(89.5,48.275);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#000000").s().p("AAcA5Ig2hJIAABJIgYAAIAAhxIAZAAIA0BHIAAhHIAYAAIAABxg");
	this.shape_42.setTransform(76.775,48.275);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#000000").s().p("AgcA0QgLgGgGgLQgFgKgBgPIAAhDIAZAAIAABDQAAAMAHAHQAHAHAMABQANgBAHgHQAHgHAAgMIAAhDIAZAAIAABDQAAAPgGAKQgGALgLAGQgLAGgSAAQgQAAgMgGg");
	this.shape_43.setTransform(64.2,48.375);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#000000").s().p("AAgA5IgIgTIgwAAIgHATIgbAAIAshxIAdAAIAsBxgAASAQIgSgwIgRAwIAjAAg");
	this.shape_44.setTransform(52.025,48.275);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#000000").s().p("AgjA5IAAhxIAYAAIAABcIAvAAIAAAVg");
	this.shape_45.setTransform(41.975,48.275);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#000000").s().p("AASA5IgVgoIgSAAIAAAoIgYAAIAAhxIA0AAQAMAAAJAFQAIAEAFAJQAFAIAAALQAAAKgEAHQgEAGgFAEQgGAEgGACIAZArgAgVgEIAZAAQAHAAAFgEQAFgEAAgIQAAgHgFgEQgFgEgHAAIgZAAg");
	this.shape_46.setTransform(175.175,29.575);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#000000").s().p("AgcA0QgLgGgGgLQgFgKgBgPIAAhDIAZAAIAABDQAAAMAHAHQAGAHANABQAOgBAGgHQAHgHAAgMIAAhDIAYAAIAABDQABAPgGAKQgFALgMAGQgLAGgSAAQgQAAgMgGg");
	this.shape_47.setTransform(163.1,29.675);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#000000").s().p("AgeA0QgNgIgIgNQgIgOAAgRQAAgQAIgOQAIgNANgHQAOgIAQAAQARAAAOAIQANAHAIANQAIAOAAAQQAAARgIAOQgIANgNAIQgOAHgRAAQgQAAgOgHgAgRggQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAHAFAKAAQALAAAHgFQAIgFAEgJQAFgIAAgLQAAgKgFgIQgEgJgIgFQgHgEgLAAQgKAAgHAEg");
	this.shape_48.setTransform(150.225,29.575);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#000000").s().p("AgLA5IAAgvIgshCIAcAAIAbAuIAcguIAcAAIgsBCIAAAvg");
	this.shape_49.setTransform(138.1,29.575);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#000000").s().p("AgnA5IAAhxIBPAAIAAAVIg3AAIAAAYIA2AAIAAAVIg2AAIAAAaIA3AAIAAAVg");
	this.shape_50.setTransform(123.3,29.575);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#000000").s().p("AgrA5IAAgTIA2hJIg2AAIAAgVIBVAAIAAATIg1BJIA3AAIAAAVg");
	this.shape_51.setTransform(113.025,29.575);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#000000").s().p("AgLA5IAAhxIAXAAIAABxg");
	this.shape_52.setTransform(105.6,29.575);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#000000").s().p("AAlA5IAAhRIggBRIgKAAIgghRIAABRIgYAAIAAhxIAiAAIAbBGIAbhGIAjAAIAABxg");
	this.shape_53.setTransform(95.9,29.575);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#000000").s().p("AgeA0QgNgIgIgNQgIgOAAgRQAAgQAIgOQAIgNANgHQAOgIAQAAQARAAAOAIQANAHAIANQAIAOAAAQQAAARgIAOQgIANgNAIQgOAHgRAAQgQAAgOgHgAgRggQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAHAFAKAAQALAAAHgFQAIgFAEgJQAFgIAAgLQAAgKgFgIQgEgJgIgFQgHgEgLAAQgKAAgHAEg");
	this.shape_54.setTransform(81.975,29.575);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#000000").s().p("AgLA5IAAhcIgiAAIAAgVIBaAAIAAAVIggAAIAABcg");
	this.shape_55.setTransform(70.45,29.575);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#000000").s().p("");
	this.shape_56.setTransform(60.225,29.6);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#000000").s().p("AgcA0QgMgGgFgLQgGgKABgPIAAhDIAYAAIAABDQAAAMAHAHQAGAHANABQAOgBAGgHQAHgHAAgMIAAhDIAYAAIAABDQAAAPgFAKQgGALgLAGQgMAGgRAAQgRAAgLgGg");
	this.shape_57.setTransform(48.85,29.675);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#000000").s().p("AgXA0QgOgIgIgNQgIgNAAgSQAAgRAIgNQAIgNAOgIQANgHARAAQAMAAAJAEQAKAEAGAGQAGAHAEAHIgVAKQgDgHgHgFQgHgEgJAAQgKAAgIAEQgIAFgFAJQgEAIAAAKQAAALAEAIQAFAJAIAFQAIAFAKAAQAJgBAHgEQAHgFADgHIAVAKQgEAHgGAHQgGAGgKAEQgJAEgMAAQgRAAgNgHg");
	this.shape_58.setTransform(36.825,29.575);
...
}).prototype = getMCSymbolPrototype(lib.t31, new cjs.Rectangle(-11.7,20.2,234.7,76.5), null);
...
(lib.t22 = function(mode,startPosition,loop) {
	...
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#333333").s().p("");
	this.shape_14.setTransform(163.3,10.95);
	...
	this.shape_15.setTransform(154.975,12.225);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#333333").s().p("AgRAlIAAhHIAMAAIAAALQAEgFAFgEQAGgEAIAAIAAAMIgFgBIgFABIgGACIgEAEIgDAFIAAAyg");
	this.shape_16.setTransform(148.675,12.15);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#333333").s().p("AgYAfQgFgFAAgMIAAgyIALAAIAAAvIABAHIADAGQACACAEAAIAGABQAGAAAFgDQAGgEAEgEIAAg0IALAAIAABHIgLAAIAAgKQgFAFgGADQgHAEgHAAQgLAAgHgGg");
	this.shape_17.setTransform(141.7,12.325);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#333333").s().p("");
	this.shape_18.setTransform(133,13.6);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#333333").s().p("AgFAxIAAhHIAKAAIAABHgAgFgjQgBgCgBgDQABgDABgDQADgCACAAQADAAACACQADADAAADQAAADgDACQgCACgDAAQgCAAgDgCg");
	this.shape_19.setTransform(127.2,10.95);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#333333").s().p("AgLAzIAAg+IgMAAIAAgKIAMAAIAAgFQAAgMAFgGQAGgGAJAAIAIABIAHAFIgFAHIgDgDIgGgBQgFAAgDAEQgCAEAAAHIAAAFIAOAAIAAAKIgOAAIAAA+g");
	this.shape_20.setTransform(123.9,10.775);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#333333").s().p("AATAlIAAguQAAgKgFgDQgEgEgHAAIgGABIgGACIgFAEIgEAEIAAA0IgLAAIAAhHIALAAIAAAKIAFgEIAGgEIAHgDQADgBAEAAQAXAAAAAXIAAAyg");
	this.shape_21.setTransform(117.1,12.125);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#333333").s().p("");
	this.shape_22.setTransform(108.625,12.225);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#333333").s().p("AgJAjQgGgDgFgFQgFgFgDgHQgCgHAAgIQAAgHACgHQADgHAFgFQAFgFAGgDQAHgDAHAAQAKAAAGAEQAGADAEAGIgHAGQgEgFgEgCQgFgCgFAAQgGAAgEACQgEACgEAEQgDAEgCAFQgBAFAAAFQAAAGABAFQACAFADAEQAEAEAEACQAEACAGAAQALAAAHgJIAHAGQgEAGgGADQgGAEgKAAQgHAAgHgDg");
	this.shape_23.setTransform(100.725,12.225);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#333333").s().p("AgRAFIAAgJIAjAAIAAAJg");
	this.shape_24.setTransform(94.65,12.225);
	...
	this.shape_25.setTransform(88.175,12.225);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#333333").s().p("AgRAlIAAhHIAMAAIAAALQAEgFAFgEQAGgEAIAAIAAAMIgFgBIgFABIgGACIgEAEIgDAFIAAAyg");
	this.shape_26.setTransform(81.875,12.15);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#333333").s().p("AghAzIAAhjIALAAIAAALQAEgFAHgFQAGgDAHAAQAHAAAGADQAGADAEAEQAEAFADAHQACAIAAAIQAAAJgCAGQgDAHgEAFQgEAFgGADQgGACgHAAQgHABgGgEQgGgEgFgFIAAAmgAgNglQgGAEgDAFIAAAgQADAEAGAEQAGAEAHgBQAEABAFgDQAEgCADgEIAFgIQABgFAAgGQAAgGgBgFQgCgFgDgDQgDgEgEgDQgFgCgEAAQgHABgGACg");
	this.shape_27.setTransform(74.925,13.5);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#333333").s().p("AgEAqQgEgEAAgIIAAguIgMAAIAAgKIAMAAIAAgUIALAAIAAAUIAOAAIAAAKIgOAAIAAAsQAAAEABACQACADAEAAIAEgBIAEgCIADAIQgCADgEABQgDABgFAAQgHAAgEgFg");
	this.shape_28.setTransform(64.325,11.35);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#333333").s().p("AATAyIAAgwQAAgEgCgDQgBgDgCgCQgCgCgDAAIgGgBIgGABIgGACIgFADIgEAFIAAA0IgLAAIAAhjIALAAIAAAmIAFgFIAGgDIAHgDIAHgCQAMABAFAGQAGAFAAAMIAAAyg");
	this.shape_29.setTransform(57.95,10.85);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#333333").s().p("");
	this.shape_30.setTransform(49.25,13.6);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#333333").s().p("AgEAxIAAhHIAKAAIAABHgAgEgjQgCgCgBgDQABgDACgDQACgCACAAQADAAACACQADADgBADQABADgDACQgCACgDAAQgCAAgCgCg");
	this.shape_31.setTransform(43.45,10.95);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#333333").s().p("AgRAlIAAhHIAMAAIAAALQAEgFAFgEQAGgEAIAAIAAAMIgFgBIgFABIgGACIgEAEIgDAFIAAAyg");
	this.shape_32.setTransform(39.675,12.15);
	...
	this.shape_33.setTransform(28.675,12.225);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#333333").s().p("AATAyIAAgwQAAgEgCgDQAAgDgCgCQgDgCgDAAIgHgBIgFABIgGACIgFADIgEAFIAAA0IgLAAIAAhjIALAAIAAAmIAEgFIAHgDIAHgDIAHgCQAMABAFAGQAGAFAAAMIAAAyg");
	this.shape_34.setTransform(20.3,10.85);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#333333").s().p("AgEAqQgEgEAAgIIAAguIgMAAIAAgKIAMAAIAAgUIALAAIAAAUIAOAAIAAAKIgOAAIAAAsQAAAEABACQACADAEAAIAEgBIAEgCIADAIQgCADgEABQgDABgFAAQgHAAgEgFg");
	this.shape_35.setTransform(13.975,11.35);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#333333").s().p("");
	this.shape_36.setTransform(3.3,10.95);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#333333").s().p("AATAlIAAguQAAgKgFgDQgEgEgHAAIgGABIgGACIgFAEIgEAEIAAA0IgLAAIAAhHIALAAIAAAKIAFgEIAGgEIAHgDQACgBAFAAQAXAAAAAXIAAAyg");
	this.shape_37.setTransform(-4.95,12.125);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#333333").s().p("AgEAxIAAhHIAJAAIAABHgAgEgjQgCgCAAgDQAAgDACgDQACgCACAAQADAAACACQACADAAADQAAADgCACQgCACgDAAQgCAAgCgCg");
	this.shape_38.setTransform(-10.8,10.95);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#333333").s().p("AggAyIAAhjIBBAAIAAALIg1AAIAAAgIA0AAIAAALIg0AAIAAAtg");
	this.shape_39.setTransform(-16.3,10.85);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.t22, new cjs.Rectangle(-22.8,2,192.8,34), null);
...
}).prototype = getMCSymbolPrototype(lib.t12, new cjs.Rectangle(-22.8,2,192.8,34), null);
...
(lib._336x280_LaundryRoom = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50).to({_off:false},0).to({y:217.3,alpha:1},8,cjs.Ease.get(1)).wait(62).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(92).to({_off:false,y:213.45},0).to({y:216.45,alpha:1},8).wait(51).to({alpha:0.0117},13).to({_off:true},1).wait(59).to({_off:false,y:207.15},0).to({y:210.15,alpha:1},8).wait(59).to({alpha:0.0117},11).to({_off:true},1).wait(51).to({_off:false,y:214.3},0).to({y:217.3,alpha:1},8,cjs.Ease.get(1)).wait(61).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(89).to({_off:false,y:213.45},0).to({y:216.45,alpha:1},8).wait(54).to({alpha:0.0117},13).to({_off:true},1).wait(70).to({_off:false,y:208},0).to({y:211,alpha:1},8).wait(48).to({alpha:0.0117},11).to({_off:true},1).wait(62).to({_off:false,y:216},0).to({y:219,alpha:1},8,cjs.Ease.get(1)).wait(50).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(94).to({_off:false,y:216},0).to({y:219,alpha:1},8).wait(49).to({alpha:0.0117},13).to({_off:true},1).wait(70).to({_off:false,y:208},0).to({y:211,alpha:1},8).wait(48).to({alpha:0.0117},11).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50).to({_off:false},0).to({y:58.05,alpha:1},8,cjs.Ease.get(1)).wait(62).to({alpha:0},11).to({_off:true},1).wait(92).to({_off:false,y:67.05},0).to({y:58.05,alpha:1},8,cjs.Ease.get(1)).wait(51).to({alpha:0},13).to({_off:true},1).wait(59).to({_off:false,y:79.05},0).to({y:70.05,alpha:1},8,cjs.Ease.get(1)).wait(59).to({alpha:0},11).to({_off:true},1).wait(51).to({_off:false,y:67.05},0).to({y:58.05,alpha:1},8,cjs.Ease.get(1)).wait(61).to({alpha:0},11).to({_off:true},1).wait(89).to({_off:false,y:67.05},0).to({y:58.05,alpha:1},8,cjs.Ease.get(1)).wait(54).to({alpha:0},13).to({_off:true},1).wait(70).to({_off:false,y:79.05},0).to({y:70.05,alpha:1},8,cjs.Ease.get(1)).wait(48).to({alpha:0},11).to({_off:true},1).wait(62).to({_off:false,y:67.05},0).to({y:58.05,alpha:1},8,cjs.Ease.get(1)).wait(50).to({alpha:0},11).to({_off:true},1).wait(94).to({_off:false,y:67.05},0).to({y:58.05,alpha:1},8,cjs.Ease.get(1)).wait(49).to({alpha:0},13).to({_off:true},1).wait(70).to({_off:false,y:79.05},0).to({y:70.05,alpha:1},8,cjs.Ease.get(1)).wait(48).to({alpha:0},11).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(46).to({_off:false},0).to({y:173.35,alpha:1},8,cjs.Ease.get(1)).wait(66).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(350).to({_off:false,y:182},0).to({y:173.35,alpha:1},8,cjs.Ease.get(1)).wait(65).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(361).to({_off:false,y:182},0).to({y:173.35,alpha:1},8,cjs.Ease.get(1)).wait(54).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(303));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(221).to({_off:false},0).to({y:173.35,alpha:1},8).wait(54).to({alpha:0.0117},13).to({_off:true},1).wait(356).to({_off:false,y:182},0).to({y:173.35,alpha:1},8).wait(57).to({alpha:0.0117},13).to({_off:true},1).wait(361).to({_off:false,y:182},0).to({y:173.35,alpha:1},8).wait(52).to({alpha:0.0117},13).to({_off:true},1).wait(138));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(43).to({_off:false},0).to({y:118.35,alpha:1},8,cjs.Ease.get(1)).wait(69).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(347).to({_off:false,y:149},0).to({y:118.35,alpha:1},8,cjs.Ease.get(1)).wait(68).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(358).to({_off:false,y:149},0).to({y:118.35,alpha:1},8,cjs.Ease.get(1)).wait(57).to({alpha:0.0117},11,cjs.Ease.get(-1)).to({_off:true},1).wait(303));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(218).to({_off:false},0).to({y:118.35,alpha:1},8).wait(57).to({alpha:0.0117},13).to({_off:true},1).wait(353).to({_off:false,y:149},0).to({y:118.35,alpha:1},8).wait(60).to({alpha:0.0117},13).to({_off:true},1).wait(358).to({_off:false,y:149},0).to({y:118.35,alpha:1},8).wait(55).to({alpha:0.0117},13).to({_off:true},1).wait(138));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(352).to({_off:false},0).to({y:118.35,alpha:1},8).wait(63).to({alpha:0.0117},11).to({_off:true},1).wait(361).to({_off:false,y:130.8},0).to({y:118.35,alpha:1},8).wait(54).to({alpha:0.0117},11).to({_off:true},1).wait(361).to({_off:false,y:130.8},0).to({y:118.35,alpha:1},8).wait(54).to({alpha:0.0117},11).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},35).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},74).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).to({state:[{t:this.shape}]},83).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},62).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_31}]},1).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).to({state:[{t:this.shape}]},52).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},68).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).to({state:[{t:this.shape}]},36).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},73).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).to({state:[{t:this.shape}]},80).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},65).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_31}]},1).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).to({state:[{t:this.shape}]},61).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},59).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).to({state:[{t:this.shape}]},52).to({state:[{t:this.shape_50}]},1).to({state:[{t:this.shape_51}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},62).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).to({state:[{t:this.shape}]},85).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},60).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_31}]},1).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).to({state:[{t:this.shape}]},61).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_11}]},59).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).to({state:[{t:this.shape_22}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(35).to({_off:false},0).to({_off:true},1).wait(179).to({_off:false},0).to({_off:true},1).wait(133).to({_off:false},0).to({_off:true},1).wait(121).to({_off:false},0).to({_off:true},1).wait(175).to({_off:false},0).to({_off:true},1).wait(145).to({_off:false},0).to({_off:true},1).wait(128).to({_off:false},0).to({_off:true},1).wait(164).to({_off:false},0).to({_off:true},1).wait(140).to({_off:false},0).to({_off:true},1).wait(76));
	this.timeline.addTween(cjs.Tween.get(this.shape_11).wait(46).to({_off:false},0).wait(74).to({_off:true},1).wait(100).to({_off:false},0).wait(62).to({_off:true},1).wait(71).to({_off:false},0).wait(68).to({_off:true},1).wait(58).to({_off:false},0).wait(73).to({_off:true},1).wait(97).to({_off:false},0).wait(65).to({_off:true},1).wait(80).to({_off:false},0).wait(59).to({_off:true},1).wait(69).to({_off:false},0).wait(62).to({_off:true},1).wait(102).to({_off:false},0).wait(60).to({_off:true},1).wait(80).to({_off:false},0).wait(59).to({_off:true},1).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_23).wait(216).to({_off:false},0).to({_off:true},1).wait(133).to({_off:false},0).to({_off:true},1).wait(297).to({_off:false},0).to({_off:true},1).wait(145).to({_off:false},0).to({_off:true},1).wait(293).to({_off:false},0).to({_off:true},1).wait(140).to({_off:false},0).to({_off:true},1).wait(75));
	this.timeline.addTween(cjs.Tween.get(this.shape_24).wait(217).to({_off:false},0).to({_off:true},1).wait(133).to({_off:false},0).to({_off:true},1).wait(297).to({_off:false},0).to({_off:true},1).wait(145).to({_off:false},0).to({_off:true},1).wait(293).to({_off:false},0).to({_off:true},1).wait(140).to({_off:false},0).to({_off:true},1).wait(74));
	this.timeline.addTween(cjs.Tween.get(this.shape_25).wait(218).to({_off:false},0).to({_off:true},1).wait(133).to({_off:false},0).to({_off:true},1).wait(297).to({_off:false},0).to({_off:true},1).wait(145).to({_off:false},0).to({_off:true},1).wait(293).to({_off:false},0).to({_off:true},1).wait(140).to({_off:false},0).to({_off:true},1).wait(73));
	this.timeline.addTween(cjs.Tween.get(this.shape_26).wait(219).to({_off:false},0).to({_off:true},1).wait(133).to({_off:false},0).to({_off:true},1).wait(297).to({_off:false},0).to({_off:true},1).wait(145).to({_off:false},0).to({_off:true},1).wait(293).to({_off:false},0).to({_off:true},1).wait(140).to({_off:false},0).to({_off:true},1).wait(72));
	this.timeline.addTween(cjs.Tween.get(this.shape_27).wait(220).to({_off:false},0).to({_off:true},1).wait(133).to({_off:false},0).to({_off:true},1).wait(297).to({_off:false},0).to({_off:true},1).wait(145).to({_off:false},0).to({_off:true},1).wait(293).to({_off:false},0).to({_off:true},1).wait(140).to({_off:false},0).to({_off:true},1).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_55}]},40).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_59}]},1).to({state:[{t:this.shape_60}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},74).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_55}]},1).to({state:[]},1).to({state:[{t:this.shape_55}]},77).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_74}]},1).to({state:[{t:this.shape_75}]},1).to({state:[{t:this.shape_76}]},1).to({state:[{t:this.shape_77}]},1).to({state:[{t:this.shape_78}]},1).to({state:[{t:this.shape_79}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},62).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_82}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_84}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_85}]},1).to({state:[{t:this.shape_86}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_87}]},1).to({state:[{t:this.shape_88}]},1).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_55}]},1).to({state:[]},1).to({state:[{t:this.shape_55}]},48).to({state:[{t:this.shape_89}]},1).to({state:[{t:this.shape_90}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_91}]},1).to({state:[{t:this.shape_77}]},1).to({state:[{t:this.shape_92}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_93}]},1).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},68).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_55}]},1).to({state:[]},1).to({state:[{t:this.shape_55}]},41).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_59}]},1).to({state:[{t:this.shape_60}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},73).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_55}]},1).to({state:[]},1).to({state:[{t:this.shape_55}]},74).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_74}]},1).to({state:[{t:this.shape_75}]},1).to({state:[{t:this.shape_76}]},1).to({state:[{t:this.shape_77}]},1).to({state:[{t:this.shape_78}]},1).to({state:[{t:this.shape_79}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},65).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_82}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_84}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_85}]},1).to({state:[{t:this.shape_86}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_87}]},1).to({state:[{t:this.shape_88}]},1).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_55}]},1).to({state:[]},1).to({state:[{t:this.shape_55}]},57).to({state:[{t:this.shape_89}]},1).to({state:[{t:this.shape_90}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_91}]},1).to({state:[{t:this.shape_77}]},1).to({state:[{t:this.shape_92}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_93}]},1).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},59).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_55}]},1).to({state:[]},1).to({state:[{t:this.shape_55}]},52).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_59}]},1).to({state:[{t:this.shape_60}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},62).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_55}]},1).to({state:[]},1).to({state:[{t:this.shape_55}]},85).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_75}]},1).to({state:[{t:this.shape_77}]},1).to({state:[{t:this.shape_79}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},60).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_82}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_84}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_85}]},1).to({state:[{t:this.shape_86}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_87}]},1).to({state:[{t:this.shape_88}]},1).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_55}]},1).to({state:[]},1).to({state:[{t:this.shape_55}]},61).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_75}]},1).to({state:[{t:this.shape_77}]},1).to({state:[{t:this.shape_79}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},59).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_55}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.shape_55).wait(40).to({_off:false},0).to({_off:true},1).wait(90).to({_off:false},0).to({_off:true},1).wait(77).to({_off:false},0).to({_off:true},1).wait(86).to({_off:false},0).to({_off:true},1).wait(48).to({_off:false},0).to({_off:true},1).wait(88).to({_off:false},0).to({_off:true},1).wait(41).to({_off:false},0).to({_off:true},1).wait(89).to({_off:false},0).to({_off:true},1).wait(74).to({_off:false},0).to({_off:true},1).wait(89).to({_off:false},0).to({_off:true},1).wait(57).to({_off:false},0).to({_off:true},1).wait(79).to({_off:false},0).to({_off:true},1).wait(52).to({_off:false},0).to({_off:true},1).wait(78).to({_off:false},0).to({_off:true},1).wait(85).to({_off:false},0).to({_off:true},1).wait(78).to({_off:false},0).to({_off:true},1).wait(61).to({_off:false},0).to({_off:true},1).wait(75).to({_off:false},0).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.shape_56).wait(41).to({_off:false},0).to({_off:true},1).wait(250).to({_off:false},0).to({_off:true},1).wait(55).to({_off:false},0).to({_off:true},1).wait(128).to({_off:false},0).to({_off:true},1).wait(249).to({_off:false},0).to({_off:true},1).wait(64).to({_off:false},0).to({_off:true},1).wait(130).to({_off:false},0).to({_off:true},1).wait(238).to({_off:false},0).to({_off:true},1).wait(142));
	this.timeline.addTween(cjs.Tween.get(this.shape_58).wait(43).to({_off:false},0).to({_off:true},1).wait(174).to({_off:false},0).to({_off:true},1).wait(260).to({_off:false},0).to({_off:true},1).wait(170).to({_off:false},0).to({_off:true},1).wait(274).to({_off:false},0).to({_off:true},1).wait(379));
	this.timeline.addTween(cjs.Tween.get(this.shape_61).wait(46).to({_off:false},0).wait(74).to({_off:true},1).wait(100).to({_off:false},0).wait(62).to({_off:true},1).wait(71).to({_off:false},0).wait(68).to({_off:true},1).wait(58).to({_off:false},0).wait(73).to({_off:true},1).wait(97).to({_off:false},0).wait(65).to({_off:true},1).wait(80).to({_off:false},0).wait(59).to({_off:true},1).wait(69).to({_off:false},0).wait(62).to({_off:true},1).wait(102).to({_off:false},0).wait(60).to({_off:true},1).wait(80).to({_off:false},0).wait(59).to({_off:true},1).wait(11));
	this.timeline.addTween(cjs.Tween.get(this.shape_62).wait(121).to({_off:false},0).to({_off:true},1).wait(232).to({_off:false,y:140},0).to({_off:true},1).wait(69).to({_off:false,y:140.025},0).to({_off:true},1).wait(131).to({_off:false},0).to({_off:true},1).wait(241).to({_off:false,y:140},0).to({_off:true},1).wait(60).to({_off:false,y:140.025},0).to({_off:true},1).wait(131).to({_off:false},0).to({_off:true},1).wait(302).to({_off:false},0).to({_off:true},1).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_72).wait(210).to({_off:false},0).to({_off:true},1).wait(84).to({_off:false},0).to({_off:true},1).wait(346).to({_off:false},0).to({_off:true},1).wait(87).to({_off:false},0).to({_off:true},1).wait(434).to({_off:false},0).to({_off:true},1).wait(139));
	this.timeline.addTween(cjs.Tween.get(this.shape_77).wait(215).to({_off:false},0).to({_off:true},1).wait(134).to({_off:false},0).to({_off:true},1).wait(296).to({_off:false},0).to({_off:true},1).wait(146).to({_off:false},0).to({_off:true},1).wait(295).to({_off:false},0).to({_off:true},1).wait(140).to({_off:false},0).to({_off:true},1).wait(73));
	this.timeline.addTween(cjs.Tween.get(this.shape_80).wait(219).to({_off:false},0).to({_off:true},1).wait(65).to({_off:false},0).to({_off:true},1).wait(365).to({_off:false},0).to({_off:true},1).wait(68).to({_off:false},0).to({_off:true},1).wait(371).to({_off:false},0).to({_off:true},1).wait(62).to({_off:false},0).to({_off:true},1).wait(77).to({_off:false},0).to({_off:true},1).wait(71));
	this.timeline.addTween(cjs.Tween.get(this.shape_81).wait(220).to({_off:false},0).to({_off:true},1).wait(63).to({_off:false},0).to({_off:true},1).wait(367).to({_off:false},0).to({_off:true},1).wait(66).to({_off:false},0).to({_off:true},1).wait(434).to({_off:false},0).to({_off:true},1).wait(150));
	this.timeline.addTween(cjs.Tween.get(this.shape_83).wait(287).to({_off:false},0).to({_off:true},1).wait(64).to({_off:false},0).to({_off:true},1).wait(369).to({_off:false},0).to({_off:true},1).wait(73).to({_off:false},0).to({_off:true},1).wait(360).to({_off:false},0).to({_off:true},1).wait(147));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/336x280_LaundryRoom_atlas_P_.png", id:"336x280_LaundryRoom_atlas_P_"},
		{src:"images/336x280_LaundryRoom_atlas_NP_.jpg", id:"336x280_LaundryRoom_atlas_NP_"}
	],
	preloads: []
};
