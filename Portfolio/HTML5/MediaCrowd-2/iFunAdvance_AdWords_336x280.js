9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAFA4IAAhZQgFAFgFADIgMAGIAAgNQAIgEAHgFQAFgGAFgIIAKAAIAABvg");
	this.shape_8.setTransform(84.8,27.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgYArQgJgQAAgbQAAgbAJgPQAJgPAPAAQAQAAAJAPQAJAPAAAbQAAAbgJAQQgJAPgQAAQgPAAgJgPgAgNgjQgFAMAAAXQAAAXAFAMQAEAMAJAAQAKAAAFgMQAFgMAAgXQAAgXgFgMQgFgLgKAAQgJAAgEALg");
	this.shape_9.setTransform(77.3,27.9);
...
// stage content:
(lib.iFunAdvance_AdWords_336x280 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 22
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.004)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape.setTransform(168.6,141.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.141)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_1.setTransform(168.6,141.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.267)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_2.setTransform(168.6,141.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(0,0,0,0.384)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_3.setTransform(168.6,141.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(0,0,0,0.49)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_4.setTransform(168.6,141.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.588)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_5.setTransform(168.6,141.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,0,0,0.675)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_6.setTransform(168.6,141.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("rgba(0,0,0,0.753)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_7.setTransform(168.6,141.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("rgba(0,0,0,0.816)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_8.setTransform(168.6,141.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("rgba(0,0,0,0.875)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_9.setTransform(168.6,141.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("rgba(0,0,0,0.918)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_10.setTransform(168.6,141.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("rgba(0,0,0,0.953)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_11.setTransform(168.6,141.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("rgba(0,0,0,0.98)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_12.setTransform(168.6,141.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("rgba(0,0,0,0.996)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_13.setTransform(168.6,141.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_14.setTransform(168.6,141.7);
	...
	this.instance.parent = this;
	this.instance.setTransform(166.8,248.4,1.113,1.113,0,0,0,131.6,28.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(264).to({_off:false},0).to({y:226.1,alpha:1},15,cjs.Ease.get(1)).wait(101));

	// txt-1
	this.instance_1 = new lib.txt1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(535.1,243.4,1.113,1.113,0,0,0,111.2,23.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:201.3},14,cjs.Ease.get(1)).wait(81).to({x:223.6,alpha:0},16,cjs.Ease.get(-1)).to({_off:true},1).wait(254));

	// achive
	this.instance_2 = new lib.achive();
	this.instance_2.parent = this;
	this.instance_2.setTransform(389.4,147.4,1.313,1.313,60,0,0,39,38.8);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(28).to({_off:false},0).to({regX:38.8,regY:38.9,rotation:0,x:278},14,cjs.Ease.get(1)).wait(52).to({regX:39,regY:38.8,rotation:60,x:389.4},15,cjs.Ease.get(-1)).to({_off:true},1).wait(270));

	// logo-small
	this.instance_3 = new lib.logosmall();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-98.3,24.4,1.113,1.113,0,0,0,52.9,10.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:53,x:70.8},14,cjs.Ease.get(1)).wait(215).to({x:48.6,alpha:0},15,cjs.Ease.get(-1)).to({_off:true},1).wait(135));

	// txt-2
	this.instance_4 = new lib.txt2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(212.6,240.8,1.113,1.113,0,0,0,119,16.6);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(125).to({_off:false},0).to({x:190.3,alpha:1},16,cjs.Ease.get(1)).wait(72).to({x:212.6,alpha:0},15,cjs.Ease.get(-1)).to({_off:true},1).wait(151));

	// logo-big
	this.instance_5 = new lib.logobig();
	this.instance_5.parent = this;
	this.instance_5.setTransform(77.1,69.6,1.113,1.113,0,0,0,76.6,38);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(249).to({_off:false},0).to({regX:76.7,x:99.5,alpha:1},15,cjs.Ease.get(1)).wait(116));

	// Слой 17
	this.instance_6 = new lib.pc2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(451.7,129.1,1.113,1.113,0,0,0,98.2,114);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(236).to({_off:false},0).to({regX:98.1,x:307},13,cjs.Ease.get(1)).wait(131));

	// apply noq
	this.instance_7 = new lib.applynoq();
	this.instance_7.parent = this;
	this.instance_7.setTransform(22.9,155.6,1.113,1.113,0,0,0,150.6,13.6);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(249).to({_off:false},0).to({regX:150.5,x:167.4,alpha:1},15,cjs.Ease.get(1)).wait(116));

	// Слой 18
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIg9BSIgTAZIkRFsg");
	this.shape_15.setTransform(-102.7,24.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIhmCIIjRAVIjuE6g");
	this.shape_16.setTransform(-79.4,24.7);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIiLC5ImBATIjNELg");
	this.shape_17.setTransform(-57.8,24.7);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIitDnIojAOIiwDig");
	this.shape_18.setTransform(-38,24.7);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIjNEQIq2ANIiUC6g");
	this.shape_19.setTransform(-19.8,24.7);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIjoE1Is8ALIh8CXg");
	this.shape_20.setTransform(-3.5,24.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIkCFXIuzAJIhmB3g");
	this.shape_21.setTransform(11.2,24.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIkYF1IwdAHIhTBbg");
	this.shape_22.setTransform(24.2,24.7);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIksGPIx4AFIhCBDg");
	this.shape_23.setTransform(35.4,24.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIk8GlIzGADIg0Avg");
	this.shape_24.setTransform(44.9,24.7);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIlJG3I0GACIgoAeg");
	this.shape_25.setTransform(52.6,24.7);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIlUHFI03ABIgeARg");
	this.shape_26.setTransform(58.7,24.7);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIlbHPI1aAAIgYAIg");
	this.shape_27.setTransform(63,24.7);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("rgba(255,255,255,0.8)").s().p("AwNDsIAAnXMAgbAAAIlgHVI1vAAIgUACg");
	this.shape_28.setTransform(65.6,24.7);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("rgba(255,255,255,0.8)").s().p("ArJDsIgTAAIkxAAIAAnXMAgbAAAIlhHXg");
	this.shape_29.setTransform(66.4,24.7);
	...
	// Слой 19
	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("rgba(0,0,0,0.004)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_30.setTransform(164.7,230.9);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("rgba(0,0,0,0.106)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_31.setTransform(164.7,230.9);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("rgba(0,0,0,0.204)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_32.setTransform(164.7,230.9);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("rgba(0,0,0,0.29)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_33.setTransform(164.7,230.9);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("rgba(0,0,0,0.373)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_34.setTransform(164.7,230.9);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("rgba(0,0,0,0.447)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_35.setTransform(164.7,230.9);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("rgba(0,0,0,0.514)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_36.setTransform(164.7,230.9);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("rgba(0,0,0,0.573)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_37.setTransform(164.7,230.9);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("rgba(0,0,0,0.627)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_38.setTransform(164.7,230.9);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("rgba(0,0,0,0.675)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_39.setTransform(164.7,230.9);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("rgba(0,0,0,0.71)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_40.setTransform(164.7,230.9);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("rgba(0,0,0,0.745)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_41.setTransform(164.7,230.9);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("rgba(0,0,0,0.769)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_42.setTransform(164.7,230.9);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("rgba(0,0,0,0.784)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_43.setTransform(164.7,230.9);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("rgba(0,0,0,0.796)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_44.setTransform(164.7,230.9);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("rgba(0,0,0,0.8)").s().p("A7MJZIAAyxMA2ZAAAIAASxg");
	this.shape_45.setTransform(164.7,230.9);
	...
	// Слой 16
	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("rgba(0,0,0,0.8)").s().p("A6EF8II4r3MArRAAAIAAL3g");
	this.shape_46.setTransform(501.2,241.9);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("rgba(0,0,0,0.8)").s().p("A6HF8II4r3MArXAAAIAAL3g");
	this.shape_47.setTransform(455.5,241.9);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("rgba(0,0,0,0.8)").s().p("A6JF8II3r3MArcAAAIAAL3g");
	this.shape_48.setTransform(413.2,241.9);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("rgba(0,0,0,0.8)").s().p("A6MF8II4r3MArhAAAIAAL3g");
	this.shape_49.setTransform(374.3,241.9);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("rgba(0,0,0,0.8)").s().p("A6OF8II4r3MArlAAAIAAL3g");
	this.shape_50.setTransform(338.8,241.9);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("rgba(0,0,0,0.8)").s().p("A6QF8II3r3MArqAAAIAAL3g");
	this.shape_51.setTransform(306.6,241.9);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("rgba(0,0,0,0.8)").s().p("A6SF8II4r3MArtAAAIAAL3g");
	this.shape_52.setTransform(277.8,241.9);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("rgba(0,0,0,0.8)").s().p("A6UF8II4r3MArxAAAIAAL3g");
	this.shape_53.setTransform(252.5,241.9);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("rgba(0,0,0,0.8)").s().p("A6VF8II4r3MArzAAAIAAL3g");
	this.shape_54.setTransform(230.5,241.9);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("rgba(0,0,0,0.8)").s().p("A6WF8II3r3MAr2AAAIAAL3g");
	this.shape_55.setTransform(211.8,241.9);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("rgba(0,0,0,0.8)").s().p("A6XF8II3r3MAr4AAAIAAL3g");
	this.shape_56.setTransform(196.6,241.9);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("rgba(0,0,0,0.8)").s().p("A6YF8II4r3MAr5AAAIAAL3g");
	this.shape_57.setTransform(184.8,241.9);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("rgba(0,0,0,0.8)").s().p("A6YF8II3r3MAr6AAAIAAL3g");
	this.shape_58.setTransform(176.3,241.9);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("rgba(0,0,0,0.8)").s().p("A6ZF8II4r3MAr7AAAIAAL3g");
	this.shape_59.setTransform(171.2,241.9);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("rgba(0,0,0,0.8)").s().p("A6nF8II4r3MAsXAAAIAAL3g");
	this.shape_60.setTransform(170.9,241.9);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("rgba(0,0,0,0.796)").s().p("A6mF8II3r3MAsWAAAIAAL3g");
	this.shape_61.setTransform(171,241.9);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("rgba(0,0,0,0.784)").s().p("A6mF8II4r3MAsVAAAIAAL3g");
	this.shape_62.setTransform(171.1,241.9);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("rgba(0,0,0,0.769)").s().p("Axul6MAsUgABIAAL3Mg1LAAAg");
	this.shape_63.setTransform(171.2,241.9);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("rgba(0,0,0,0.745)").s().p("Axul6MAsQgABIADABIAAL2Mg1JAAAg");
	this.shape_64.setTransform(171.5,241.9);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("rgba(0,0,0,0.71)").s().p("A6jF8II2r1IARgCMAr9AAAIADABIAAL1IgJABg");
	this.shape_65.setTransform(171.8,241.9);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("rgba(0,0,0,0.675)").s().p("A6hF8II1r1IAQgCMAr8AAAIACABIAAL1IgIABg");
	this.shape_66.setTransform(172.2,241.9);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("rgba(0,0,0,0.627)").s().p("A6fF8II1r0IAPgDMAr4AAAIADABIAAL0IgIACg");
	this.shape_67.setTransform(172.6,241.9);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("rgba(0,0,0,0.573)").s().p("A6dF8II0rzIAPgEMAr2AAAIACABIAALzIgIADg");
	this.shape_68.setTransform(173.1,241.9);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("rgba(0,0,0,0.514)").s().p("A6aF8II0ryIAOgFMArxAAAIACACIAALyIgGADg");
	this.shape_69.setTransform(173.7,241.9);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("rgba(0,0,0,0.447)").s().p("A6XF8IIzrxIAOgGMArtAAAIABACIAALwIgFAFg");
	this.shape_70.setTransform(174.3,241.9);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("rgba(0,0,0,0.373)").s().p("A6UF8IIyrwIANgHMArpAAAIABACIAALvIgFAGg");
	this.shape_71.setTransform(175.1,241.9);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("rgba(0,0,0,0.29)").s().p("A6QF8IIwrvIANgIMArjAAAIABADIAALtIgDAHg");
	this.shape_72.setTransform(175.8,241.9);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("rgba(0,0,0,0.204)").s().p("A6MF8IIvrtIAMgKMAreAAAIABADIAALsIgDAIg");
	this.shape_73.setTransform(176.7,241.9);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("rgba(0,0,0,0.106)").s().p("A6IF8IIurrIALgMMArYAAAIAALuIgBAJg");
	this.shape_74.setTransform(177.6,241.9);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("rgba(0,0,0,0.004)").s().p("A6EF8II3r3MAqaAAAIA4AAIAAL3g");
	this.shape_75.setTransform(178.6,241.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_46}]},14).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).to({state:[{t:this.shape_50}]},1).to({state:[{t:this.shape_51}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_55}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_59,p:{x:171.2}}]},1).to({state:[{t:this.shape_59,p:{x:169.5}}]},1).to({state:[{t:this.shape_60}]},185).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_74}]},1).to({state:[{t:this.shape_75}]},1).to({state:[]},1).wait(151));

	// Слой 20
	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#000000").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_76.setTransform(168.6,141.7);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("rgba(0,0,0,0.863)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_77.setTransform(168.6,141.7);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("rgba(0,0,0,0.737)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_78.setTransform(168.6,141.7);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("rgba(0,0,0,0.62)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_79.setTransform(168.6,141.7);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("rgba(0,0,0,0.514)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_80.setTransform(168.6,141.7);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("rgba(0,0,0,0.416)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_81.setTransform(168.6,141.7);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("rgba(0,0,0,0.329)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_82.setTransform(168.6,141.7);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("rgba(0,0,0,0.255)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_83.setTransform(168.6,141.7);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("rgba(0,0,0,0.188)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_84.setTransform(168.6,141.7);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("rgba(0,0,0,0.129)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_85.setTransform(168.6,141.7);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("rgba(0,0,0,0.086)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_86.setTransform(168.6,141.7);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f("rgba(0,0,0,0.051)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_87.setTransform(168.6,141.7);

	this.shape_88 = new cjs.Shape();
	this.shape_88.graphics.f("rgba(0,0,0,0.024)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_88.setTransform(168.6,141.7);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.f("rgba(0,0,0,0.008)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_89.setTransform(168.6,141.7);

	this.shape_90 = new cjs.Shape();
	this.shape_90.graphics.f("rgba(0,0,0,0.004)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_90.setTransform(168.6,141.7);

	this.shape_91 = new cjs.Shape();
	this.shape_91.graphics.f("rgba(255,255,255,0.004)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_91.setTransform(168.6,141.7);

	this.shape_92 = new cjs.Shape();
	this.shape_92.graphics.f("rgba(255,255,255,0.008)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_92.setTransform(168.6,141.7);

	this.shape_93 = new cjs.Shape();
	this.shape_93.graphics.f("rgba(255,255,255,0.024)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_93.setTransform(168.6,141.7);

	this.shape_94 = new cjs.Shape();
	this.shape_94.graphics.f("rgba(255,255,255,0.051)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_94.setTransform(168.6,141.7);

	this.shape_95 = new cjs.Shape();
	this.shape_95.graphics.f("rgba(255,255,255,0.086)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_95.setTransform(168.6,141.7);

	this.shape_96 = new cjs.Shape();
	this.shape_96.graphics.f("rgba(255,255,255,0.129)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_96.setTransform(168.6,141.7);

	this.shape_97 = new cjs.Shape();
	this.shape_97.graphics.f("rgba(255,255,255,0.188)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_97.setTransform(168.6,141.7);

	this.shape_98 = new cjs.Shape();
	this.shape_98.graphics.f("rgba(255,255,255,0.255)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_98.setTransform(168.6,141.7);

	this.shape_99 = new cjs.Shape();
	this.shape_99.graphics.f("rgba(255,255,255,0.329)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_99.setTransform(168.6,141.7);

	this.shape_100 = new cjs.Shape();
	this.shape_100.graphics.f("rgba(255,255,255,0.416)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_100.setTransform(168.6,141.7);

	this.shape_101 = new cjs.Shape();
	this.shape_101.graphics.f("rgba(255,255,255,0.514)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_101.setTransform(168.6,141.7);

	this.shape_102 = new cjs.Shape();
	this.shape_102.graphics.f("rgba(255,255,255,0.62)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_102.setTransform(168.6,141.7);

	this.shape_103 = new cjs.Shape();
	this.shape_103.graphics.f("rgba(255,255,255,0.737)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_103.setTransform(168.6,141.7);

	this.shape_104 = new cjs.Shape();
	this.shape_104.graphics.f("rgba(255,255,255,0.863)").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_104.setTransform(168.6,141.7);

	this.shape_105 = new cjs.Shape();
	this.shape_105.graphics.f("#FFFFFF").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
	this.shape_105.setTransform(168.6,141.7);
	...
	this.instance_8.setTransform(167.5,108.2,1.113,1.113,0,0,0,151.2,226.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(125).to({regY:226.8,y:132.8},16,cjs.Ease.get(1)).to({_off:true},108).wait(131));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-38.4,77.2,543,465.6);
// library properties:
lib.properties = {
	width: 336,
	height: 280,
	...
	webfonts: {},
	manifest: [
		{src:"images/iFunAdvance_AdWords_336x280_atlas_.png", id:"iFunAdvance_AdWords_336x280_atlas_"}
	],
	preloads: []
};
