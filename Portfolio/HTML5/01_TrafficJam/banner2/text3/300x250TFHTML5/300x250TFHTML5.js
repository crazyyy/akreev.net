...
(lib.t12 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(129.6375,51.725);
	...
	this.shape_1.setTransform(124.225,51.3732);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#00A575").s().p("AgHA7IgBAAIgBgCIAAhyIABgBIABAAIAPAAIABAAIABABIAAByIgBACIgBAAg");
	this.shape_2.setTransform(120.1,51.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#00A575").s().p("");
	this.shape_3.setTransform(114.825,53);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#00A575").s().p("");
	this.shape_4.setTransform(107.85,53);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#00A575").s().p("AgTAsIgBAAIgBgCIAAhSIABgCIABAAIAQAAIABAAIABACIAAAIIAAAAIABAAQABgFADgDQAEgDAGAAIAEAAIADACIABABIAAABIgDAQIgBABIgBAAIgEAAIgEAAQgFABgDAFQgCAEAAAGIAAAwIgBACIgBAAg");
	this.shape_5.setTransform(102.075,52.95);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#00A575").s().p("AgGAsQgGAAgFgDQgFgCgEgGQgDgFAAgJIAAg8IABgCIABAAIAQAAIACAAIAAACIAAA3QAAAHACADQADADAEAAQAFAAADgEQACgDAAgGIAAg3IAAgCIACAAIAPAAIACAAIABACIAABSIgBABIgCABIgPAAIgCgBIAAgBIAAgEIgBgBIAAABQgDAEgEABQgCACgEAAIgCAAg");
	this.shape_6.setTransform(95.35,53.055);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#00A575").s().p("AgVAmQgIgIAAgNIAAgiQAAgLAIgIQAIgIANAAQAOAAAIAIQAIAIAAALIAAAiQAAANgIAIQgIAGgOABQgNgBgIgGgAgHgXQgCADgBAGIAAAeQABAFACADQADAEAEAAQAFAAADgEQADgDAAgFIAAgeQAAgGgDgDQgDgEgFAAQgEAAgDAEg");
	this.shape_7.setTransform(87.975,53);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#00A575").s().p("AgHA7IgBAAIgBgCIAAguIAAAAIAAgBIgYhCIAAgCIACAAIAQAAIACAAIABABIAMAsIAAAAIABAAIAMgsIABgBIACAAIAQAAIACAAIAAACIgYBCIAAABIAAAAIAAAuIgBACIgBAAg");
	this.shape_8.setTransform(80.425,51.4);
	...
	this.shape_9.setTransform(69.575,53);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#00A575").s().p("AgVAmQgIgIAAgNIAAgiQAAgLAIgIQAIgIANAAQAJABAHADQAHADADAGQAEAGAAAHIAAADIgBABIgBABIgQABIgBgBIgBgBIAAgDQAAgEgDgCQgCgEgFAAQgEAAgDAEQgCADgBAGIAAAeQABAFACADQADAEAEAAQAFAAACgEQADgDAAgEIAAgCIABgBIABAAIAQAAIABAAIABABIAAADQAAAMgIAIQgIAGgOABQgNgBgIgGg");
	this.shape_10.setTransform(62.425,53);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#00A575").s().p("");
	this.shape_11.setTransform(54.975,53);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#00A575").s().p("AgTAsIgBAAIgBgCIAAhSIABgCIABAAIAQAAIABAAIABACIAAAIIAAAAIABAAQABgFADgDQAEgDAGAAIAEAAIADACIABABIAAABIgDAQIgBABIgBAAIgEAAIgEAAQgFABgDAFQgCAEAAAGIAAAwIgBACIgBAAg");
	this.shape_12.setTransform(49.075,52.95);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#00A575").s().p("");
	this.shape_13.setTransform(42.4,51.4);
	...
	this.shape_14.setTransform(35.3625,51.725);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.t12, new cjs.Rectangle(31.5,38.7,132.7,25.299999999999997), null);
...
(lib.t11 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(146.2,29.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AgeBAQgMgMABgVIAAhoIAAgCIACAAIAZAAIACAAIABACIAABsQAAAHADAEQADAEAFAAQAGAAADgEQAEgEAAgHIAAhsIAAgCIACAAIAZAAIACAAIAAACIAABoQABAOgGAKQgFAKgJAFQgKAGgNAAQgTAAgLgMg");
	this.shape_1.setTransform(136.15,29.525);
	...
	this.shape_2.setTransform(126.825,29.425);
	...
	this.shape_3.setTransform(116.775,29.425);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AgMBLIgCAAIgBgCIAAh4IAAgBIgBAAIgaAAIgBgBIgBgCIAAgVIABgCIABAAIBVAAIACAAIAAACIAAAVIAAACIgCABIgbAAIgBAAIAAABIAAB4IgBACIgCAAg");
	this.shape_4.setTransform(106.6,29.425);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("AgMBLIgCAAIAAgCIAAiRIAAgCIACAAIAYAAIACAAIABACIAACRIgBACIgCAAg");
	this.shape_5.setTransform(99.075,29.425);
	...
	this.shape_6.setTransform(91.225,29.425);
	...
	this.shape_7.setTransform(81.675,29.425);
	...
	this.shape_8.setTransform(71.225,29.425);
	...
	this.shape_9.setTransform(60.55,29.525);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("");
	this.shape_10.setTransform(46.325,29.425);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("AgMBLIgCAAIAAgCIAAiRIAAgCIACAAIAYAAIACAAIABACIAACRIgBACIgCAAg");
	this.shape_11.setTransform(38.975,29.425);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#333333").s().p("AgkBLIgCAAIAAgCIAAiRIAAgCIACAAIBJAAIABAAIACACIAAAVIgCACIgBABIgsAAIgBAAIAAABIAAAiIAAAAIABABIAYAAIACABIABABIAAAUIgBACIgCABIgYAAIgBAAIAAABIAAAiIAAABIABAAIAsAAIABABIACACIAAAVIgCACIgBAAg");
	this.shape_12.setTransform(103.65,7.225);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#333333").s().p("AAQBLIgCAAIgBgCIgbhQIAAAAIgBAAIAABQIAAACIgCAAIgZAAIgCAAIgBgCIAAiRIABgCIACAAIAbAAIACAAIABACIAbBPIAAABIABgBIAAhPIABgCIABAAIAZAAIACAAIABACIAACRIgBACIgCAAg");
	this.shape_13.setTransform(93.225,7.225);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#333333").s().p("AgfBBQgMgLAAgUIAAhEQAAgTAMgMQAMgLATAAQANAAAKAFQAKAFAFAKQAFAJAAANIAABEQAAANgFAKQgFAKgKAFQgKAFgNAAQgTAAgMgMgAgJguQgDAEAAAHIAABHQAAAHADAEQAEAEAFAAQAGAAADgEQAEgEAAgHIAAhHQAAgHgEgEQgDgEgGAAQgFAAgEAEg");
	this.shape_14.setTransform(82.6,7.225);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#333333").s().p("AgkBLIgCAAIgBgCIAAiRIABgCIACAAIBJAAIACAAIAAACIAAAVIAAACIgCABIgsAAIgBAAIAAABIAAAiIAAAAIABABIAZAAIACABIAAABIAAAUIAAACIgCABIgZAAIgBAAIAAABIAAAiIAAABIABAAIAsAAIACABIAAACIAAAVIAAACIgCAAg");
	this.shape_15.setTransform(73,7.225);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#333333").s().p("AAWBLIgCAAIAAgCIAAhcIgBgBIgBABIgRAgIAAABIgBABIAAgBIAAgBIgRghIgBgBIAAABIAABdIgBACIgCAAIgZAAIgCAAIgBgCIAAiRIABgCIACAAIAZAAIABAAIACACIASAoQAAAAAAAAQAAAAAAAAQAAAAAAAAQAAAAABAAIASgoIACgCIABAAIAZAAIACAAIABACIAACRIgBACIgCAAg");
	this.shape_16.setTransform(62.225,7.225);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#333333").s().p("AgfBBQgMgLAAgUIAAhEQAAgTAMgMQAMgLATAAQANAAAJAFQAKAFAGAKQAFAJABANIAABEQgBANgFAKQgGAKgKAFQgJAFgNAAQgTAAgMgMgAgIguQgEAEgBAHIAABHQABAHAEAEQADAEAFAAQAGAAAEgEQADgEAAgHIAAhHQAAgHgDgEQgEgEgGAAQgFAAgDAEg");
	this.shape_17.setTransform(51.25,7.225);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#333333").s().p("");
	this.shape_18.setTransform(41.375,7.225);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#333333").s().p("");
	this.shape_19.setTransform(154.225,-14.975);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#333333").s().p("AAQBLIgCAAIgBgCIgbhQIAAAAIgBAAIAABQIAAACIgCAAIgZAAIgCAAIgBgCIAAiRIABgCIACAAIAbAAIACAAIABACIAbBPIAAABIABgBIAAhPIABgCIABAAIAZAAIACAAIABACIAACRIgBACIgCAAg");
	this.shape_20.setTransform(143.825,-14.975);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#333333").s().p("");
	this.shape_21.setTransform(133.325,-14.975);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#333333").s().p("AgMBLIgCAAIAAgCIAAiRIAAgCIACAAIAYAAIACAAIABACIAACRIgBACIgCAAg");
	this.shape_22.setTransform(125.875,-14.975);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#333333").s().p("");
	this.shape_23.setTransform(118.625,-14.975);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#333333").s().p("AAQBLIgCAAIgBgCIgQg7IAAgBIgBAAIgHAAIgBAAIAAABIAAA7IgBACIgCAAIgZAAIgCAAIgBgCIAAiQIABgCIACgCIAqAAQAMABAKAFQAJAGAFALQAFAKAAANQAAANgFAJQgFAJgJAGIAAABIAAAAIAUBAIgBABIgBABgAgMgvIAAAlIAAABIABAAIAJAAQAGgBAEgFQAEgFAAgIQAAgKgEgFQgEgFgGAAIgJAAIgBAAIAAABg");
	this.shape_24.setTransform(104.625,-15);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#333333").s().p("AAVBLIgCAAIgBgCIgDgVIgBAAIgBgBIgaAAIAAAAIgBABIgEAVIgBACIgBAAIgaAAIgCAAIAAgDIAgiQIABgCIACAAIAcAAIACAAIAAACIAgCQIAAADIgCAAgAAAgcIgJA3IAAABIABAAIARAAIABgBIAAAAIgJg3IAAAAIgBAAg");
	this.shape_25.setTransform(93.925,-14.975);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#333333").s().p("AgkBLIgCAAIgBgCIAAiRIABgCIACAAIBJAAIACAAIABACIAAAVIgBACIgCABIgsAAIgBAAIAAABIAAAiIAAAAIABABIAYAAIADABIAAABIAAAUIAAACIgDABIgYAAIgBAAIAAABIAAAiIAAABIABAAIAsAAIACABIABACIAAAVIgBACIgCAAg");
	this.shape_26.setTransform(84.05,-14.975);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#333333").s().p("AgkBLIgCAAIAAgCIAAiRIAAgCIACAAIAZAAIACAAIABACIAAB4IAAABIABAAIAsAAIACABIABACIAAAVIgBACIgCAAg");
	this.shape_27.setTransform(74.85,-14.975);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#333333").s().p("");
	this.shape_28.setTransform(65.025,-14.975);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#333333").s().p("AgDBLIgBAAIgBgCIAAh2IgBgBIAAAAIgPADIgCAAIgBgCIAAgTIABgBIABgCIAPgHIACAAIACAAIAZAAIABAAIACACIAACRIgCACIgBAAg");
	this.shape_29.setTransform(52.5,-14.975);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#333333").s().p("");
	this.shape_30.setTransform(43.125,-15);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.t11, new cjs.Rectangle(35.2,-29.9,177,74), null);
...
(lib._300x250TFHTML5 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(-8.45,111.5,1.9155,1.9155);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-33.95,alpha:1},15,cjs.Ease.get(1)).wait(50).to({scaleX:1.4991,scaleY:1.4991,x:-41.6,y:92.4},16,cjs.Ease.get(1)).to({_off:true},78).wait(110).to({_off:false,scaleX:1.9155,scaleY:1.9155,x:-8.45,y:111.5,alpha:0},0).to({x:-33.95,alpha:1},15,cjs.Ease.get(1)).wait(50).to({scaleX:1.4991,scaleY:1.4991,x:-41.6,y:92.4},16,cjs.Ease.get(1)).to({_off:true},78).wait(110).to({_off:false,scaleX:1.9155,scaleY:1.9155,x:-8.45,y:111.5,alpha:0},0).to({x:-33.95,alpha:1},15,cjs.Ease.get(1)).wait(50).to({scaleX:1.4991,scaleY:1.4991,x:-41.6,y:92.4},16,cjs.Ease.get(1)).to({_off:true},78).wait(91));
...
p.nominalBounds = new cjs.Rectangle(150,125,247.89999999999998,125);
// library properties:
lib.properties = {
