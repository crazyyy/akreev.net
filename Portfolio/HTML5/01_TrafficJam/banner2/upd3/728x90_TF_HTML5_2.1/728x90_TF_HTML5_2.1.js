...
lib.ssMetadata = [
		{name:"728x90_TF_HTML5_2.1_atlas_", frames: [[0,0,401,56]]}
];
...
(lib.logo = function() {
	this.initialize(ss["728x90_TF_HTML5_2.1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.t12 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#00A575").s().p("");
	this.shape.setTransform(85.8,69.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00A575").s().p("");
	this.shape_1.setTransform(79.05,69.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#00A575").s().p("AgHA9IgBAAIgBgCIAAhSIABgBIABgBIAPAAIABABIABABIAABSIgBACIgBAAgAgHgnQgEgDAAgGQAAgFAEgEQACgDAFAAQAGAAADADQADAEAAAFQAAAGgDADQgDADgGAAQgFAAgCgDg");
	this.shape_2.setTransform(73.75,67.725);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#00A575").s().p("AATA8IgCgBIAAgCIAAhJIgBAAIAAAAIgPAdIgBABIAAABIAAgBIgBgBIgOgdIgBAAIAAAAIAABJIgBACIgBABIgQAAIgBgBIgBgCIAAhxIABgCIABgBIAQAAIABABIABABIAQAlQAAAAAAAAQAAAAAAAAQAAAAAAAAQAAAAAAAAIARglIABgBIABgBIAQAAIABABIABACIAABxIgBACIgBABg");
	this.shape_3.setTransform(67.375,67.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#00A575").s().p("AgVAmQgIgIAAgMIAAgiQAAgMAIgIQAIgHANgBQAOABAIAHQAIAIAAAMIAAAiQAAAMgIAIQgIAGgOABQgNgBgIgGgAgHgYQgCAEgBAFIAAAfQABAFACADQADAEAEAAQAFAAADgEQADgDAAgFIAAgfQAAgFgDgEQgDgCgFgBQgEABgDACg");
	this.shape_4.setTransform(55.725,69.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#00A575").s().p("AgIA8IgBgBIgBgCIAAhiIAAgBIgBAAIgUAAIgBAAIgBgBIAAgNIABgCIABgBIA+AAIACABIABACIAAANIgBABIgCAAIgVAAIgBAAIAAABIAABiIgBACIgBABg");
	this.shape_5.setTransform(48.225,67.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#00A575").s().p("");
	this.shape_6.setTransform(37.65,69.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#00A575").s().p("");
	this.shape_7.setTransform(28.6,69.425);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#00A575").s().p("");
	this.shape_8.setTransform(19.325,69.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#00A575").s().p("");
	this.shape_9.setTransform(12.075,69.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#00A575").s().p("");
	this.shape_10.setTransform(4.7,67.9);
	...
	this.shape_11.setTransform(-6.075,69.5);
	...
	this.shape_12.setTransform(-13.425,69.425);
	...
	this.shape_14.setTransform(-27.9875,71.2);
	...
	this.shape_15.setTransform(-33.725,69.45);
	...
	this.shape_16.setTransform(-40.275,69.5);
	...
	this.shape_17.setTransform(-47.475,69.5);
	...
	this.shape_18.setTransform(-54.525,67.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#00A575").s().p("AAMA2QgIAAgEgBQgFgCgCgEQgEgFAAgIIAAgzIAAAAIgBgBIgFAAIgCAAIgBgCIAAgKIABgBIACgBIAFAAIABAAIAAAAIAAgTIABgCIACAAIANAAIABAAIABACIAAATIAAAAIABAAIALAAIABABIABABIAAAKIgBACIgBAAIgLAAIgBABIAAAAIAAAsQABAGACACQACACAEAAIACAAIABABIABABIAAANIgBACIgBAAg");
	this.shape_19.setTransform(-64.25,68.425);
	...
	this.shape_20.setTransform(-70.375,69.5);
	...
	this.shape_21.setTransform(-77.625,67.9);
	...
	this.shape_22.setTransform(-85.225,67.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.t12, new cjs.Rectangle(-94.5,55.2,189.1,25.299999999999997), null);
...
// stage content:
(lib._728x90_TF_HTML5_21 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/728x90_TF_HTML5_2.1_atlas_.png", id:"728x90_TF_HTML5_2.1_atlas_"}
	],
	preloads: []
};
