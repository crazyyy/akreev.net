...
(lib._160x600TFHTML5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-41.6,alpha:1},13,cjs.Ease.get(1)).wait(71).to({y:462.4},11,cjs.Ease.get(1)).to({_off:true},76).wait(110).to({_off:false,x:-29.1,y:245.4,alpha:0},0).to({x:-41.6,alpha:1},13,cjs.Ease.get(1)).wait(71).to({y:462.4},11,cjs.Ease.get(1)).to({_off:true},76).wait(110).to({_off:false,x:-29.1,y:245.4,alpha:0},0).to({x:-41.6,alpha:1},13,cjs.Ease.get(1)).wait(71).to({y:462.4},11,cjs.Ease.get(1)).to({_off:true},76).wait(49));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/160x600TFHTML5_atlas_.png", id:"160x600TFHTML5_atlas_"}
	],
	preloads: []
};
