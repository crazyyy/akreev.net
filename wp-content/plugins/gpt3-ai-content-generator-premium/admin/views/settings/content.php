...
<div id="tabs-2">
    <div class="wpcgai_form_row">
        ...
        <p><b><?php echo esc_html__('Language, Style and Tone','gpt3-ai-content-generator')?></b></p>
    ...
    <div class="wpcgai_form_row">
        ...
        <select class="regular-text" id="label_wpai_writing_style" name="wpaicg_settings[wpai_writing_style]" >
            ...
            <option value="busin" <?php echo (esc_html($existingValue['wpai_writing_style']) == 'busin' ? 'selected' : '' );?>><?php echo esc_html__('Business','gpt3-ai-content-generator')?></option>
            <option value="repor" <?php echo (esc_html($existingValue['wpai_writing_style']) == 'repor' ? 'selected' : '' );?>><?php echo esc_html__('Report','gpt3-ai-content-generator')?></option>
            <option value="resea" <?php echo (esc_html($existingValue['wpai_writing_style']) == 'resea' ? 'selected' : '' );?>><?php echo esc_html__('Research','gpt3-ai-content-generator')?></option>
        </select>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Writing Tone','gpt3-ai-content-generator')?>:</label>
        <select class="regular-text" id="label_wpai_writing_tone" name="wpaicg_settings[wpai_writing_tone]" >
            ...
            <option value="curio" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'curio' ? 'selected' : '' );?>><?php echo esc_html__('Curious','gpt3-ai-content-generator')?></option>
            <option value="disap" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'disap' ? 'selected' : '' );?>><?php echo esc_html__('Disappointed','gpt3-ai-content-generator')?></option>
            <option value="encou" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'encou' ? 'selected' : '' );?>><?php echo esc_html__('Encouraging','gpt3-ai-content-generator')?></option>
            <option value="optim" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'optim' ? 'selected' : '' );?>><?php echo esc_html__('Optimistic','gpt3-ai-content-generator')?></option>
            <option value="surpr" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'surpr' ? 'selected' : '' );?>><?php echo esc_html__('Surprised','gpt3-ai-content-generator')?></option>
            <option value="worry" <?php echo (esc_html($existingValue['wpai_writing_tone']) == 'worry' ? 'selected' : '' );?>><?php echo esc_html__('Worried','gpt3-ai-content-generator')?></option>
        </select>
    ...
    <hr>
    <p><b><?php echo esc_html__('Headings','gpt3-ai-content-generator')?></b></p>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Number of Headings','gpt3-ai-content-generator')?>:</label>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Heading Tag','gpt3-ai-content-generator')?>:</label>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Outline Editor','gpt3-ai-content-generator')?>:</label>
    ...
    <hr>
    <p><b><?php echo esc_html__('Additional Content','gpt3-ai-content-generator')?></b></p>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Add Tagline?','gpt3-ai-content-generator')?>:</label>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Add Q&A?','gpt3-ai-content-generator')?>:</label>
        <?php
        if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
            ?>
            <input type="checkbox" id="label_wpai_add_faq" name="wpaicg_settings[wpai_add_faq]"
                   value="<?php echo esc_html($existingValue['wpai_add_faq']); ?>"
                <?php echo esc_html($existingValue['wpai_add_faq']) == 1 ? " checked" : ""; ?>
            />
            <?php
        } else {
            ?>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Make Keywords Bold?','gpt3-ai-content-generator')?>:</label>
        <?php
        if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
            ?>
            <input type="checkbox" id="label_wpai_add_keywords_bold" name="wpaicg_settings[wpai_add_keywords_bold]"
                   value="<?php echo esc_html($existingValue['wpai_add_keywords_bold']); ?>"
                <?php echo esc_html($existingValue['wpai_add_keywords_bold']) == 1 ? " checked" : ""; ?>
            />
            <?php
        } else {
            ?>
            <input type="checkbox" value="0" disabled class="pro_chk"><?php echo esc_html__('Available in Pro','gpt3-ai-content-generator')?>
            <?php
        }
        ?>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Call-to-Action Position','gpt3-ai-content-generator')?>:</label>
    ...
    <hr>
    <p><strong><?php echo esc_html__('Table of Contents','gpt3-ai-content-generator')?></strong></p>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Add ToC?','gpt3-ai-content-generator')?>:</label>
        <?php
        $wpaicg_toc = get_option('wpaicg_toc', false);
        ?>
        <input<?php echo $wpaicg_toc ? ' checked': ''?> type="checkbox" value="1" name="wpaicg_toc">
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('ToC Title','gpt3-ai-content-generator')?>:</label>
        <?php
        $wpaicg_toc_title = get_option('wpaicg_toc_title', 'Table of Contents');
        ?>
        <input type="text" class="regular-text" value="<?php echo esc_html($wpaicg_toc_title)?>" name="wpaicg_toc_title">
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('ToC Title Tag','gpt3-ai-content-generator')?>:</label>
        <?php
    ...
    <hr>
    <p><b><?php echo esc_html__('Introduction','gpt3-ai-content-generator')?></b></p>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Add Introduction?','gpt3-ai-content-generator')?>:</label>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Intro Title Tag','gpt3-ai-content-generator')?>:</label>
        <?php
    ...
    ?>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Hide Introduction Title','gpt3-ai-content-generator')?>:</label>
        <input type="checkbox" name="wpaicg_hide_introduction" value="1"<?php echo  $wpaicg_hide_introduction ? " checked" : "" ; ?>/>
    ...
    <hr>
    <p><strong><?php echo esc_html__('Conclusion','gpt3-ai-content-generator')?></strong></p>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Add Conclusion?','gpt3-ai-content-generator')?>:</label>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Conclusion Title Tag','gpt3-ai-content-generator')?>:</label>
        <?php
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label"><?php echo esc_html__('Hide Conclusion Title','gpt3-ai-content-generator')?>:</label>
        <input type="checkbox" name="wpaicg_hide_conclusion" value="1"<?php echo  $wpaicg_hide_conclusion ? " checked" : "" ; ?>/>
    ...
    <hr>
    <p><strong><?php echo esc_html__('Custom Prompt for Express Mode','gpt3-ai-content-generator')?></strong></p>
    <div class="wpcgai_form_row">
        <?php
        ...
        ?>
        <div class="mb-5">
            <label><input<?php echo $wpaicg_content_custom_prompt_enable ? ' checked':''?> type="checkbox" class="wpaicg_meta_custom_prompt_enable" name="wpaicg_content_custom_prompt_enable">&nbsp;Enable</label>
