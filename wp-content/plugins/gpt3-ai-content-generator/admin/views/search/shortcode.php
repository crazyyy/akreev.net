                ...
                if (xhttp.readyState === 4) {
                    if (xhttp.status === 200) {
                        ...
                        if (wpaicg_response !== '') {
                            ...
                            if (wpaicg_response.status === 'success') {
                                if(wpaicg_response.data.length){
                                    ...
                                    if(wpaicg_response.source.length){
                                        wpaicgSearchSource.innerHTML = '<h3><?php echo esc_html__('Sources','gpt3-ai-content-generator')?></h3>';
                                    ...
                                    wpaicgSearchResult.innerHTML = '<p><?php echo esc_html__('No result found','gpt3-ai-content-generator')?></p>';
                                }
                            }
                            else{
                            ...
                            wpaicgSearchResult.innerHTML = '<p class="wpaicg-search-error"><?php echo esc_html__('Something went wrong','gpt3-ai-content-generator')?></p>';
                        }
                    }
                    else{
                        wpaicgSearchResult.innerHTML = '<p class="wpaicg-search-error"><?php echo esc_html__('Something went wrong','gpt3-ai-content-generator')?></p>';
